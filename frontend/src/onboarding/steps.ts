...
export const STEPS: readonly TutorialStep[] = [
  ...
  { id: 'glue', chapter: 3, dialogue: 'Switch on the droplet tool (万能胶). Drag one of my two Text cards close to the other’s edge; release when the seam appears.', target: 'tools', expects: 'glue', role: 'glueA' },
  { id: 'glue-move', chapter: 3, dialogue: 'Now drag either card. Its neighbour comes along! Select the pair to find 解除粘连 when you want to separate them.', target: 'glueA', expects: 'move', role: 'glueA' },
