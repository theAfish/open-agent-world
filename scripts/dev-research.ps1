...
& uv pip install --python (Join-Path $researchRoot 'backend/.venv/Scripts/python.exe') -e (Join-Path $researchRoot 'plugins/library') -e (Join-Path $researchRoot 'plugins/xrd') -e (Join-Path $researchRoot 'plugins/knowledge')
