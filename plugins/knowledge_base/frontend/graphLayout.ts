/**
 * Force-directed placement for the published knowledge graph.
 *
 * Copied from the MatCreator plugin rather than shared: plugin frontends are
 * bundled independently and must not import each other.
 */
